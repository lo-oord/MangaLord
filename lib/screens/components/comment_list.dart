...
import 'package:manga_lord/src/rust/api/api.dart' as api;
import 'package:manga_lord/src/rust/udto.dart';
                ...
                onTap: () async {
                  ...
                  if (comment != null && comment.isNotEmpty) {
                    try {
                      ...
                      defaultToast(context, "Sent successfully");
                    } catch (e) {
                      if (e is AnyhowException) {
                        defaultToast(context, "Send failed: ${e.message}");
                      } else {
                        defaultToast(context, "Send failed: $e");
                      }
                      debugPrint("$e");
                    }
                  }
