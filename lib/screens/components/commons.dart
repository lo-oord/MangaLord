...
import 'package:manga_lord/screens/components/android_version.dart';
...
Future saveImageFileToGallery(BuildContext context, String path) async {
  ...
  if (Platform.isIOS) {
    ...
    defaultToast(context, 'This platform is not supported yet');
  ...
  if (future == null) {
    defaultToast(context, 'Save cancelled');
    return;
  }
  await future;
}
