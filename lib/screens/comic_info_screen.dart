...
import 'package:manga_lord/screens/components/commnet_card.dart';
import 'package:manga_lord/screens/components/content_loading.dart';
import 'package:manga_lord/screens/discovery_screen.dart';
                  ...
                  return IconButton(
                    onPressed: () async {
                      ...
                      try {
                        ...
                        defaultToast(context, "${collected ? "Cancel" : ""}Added to favorites successfully");
                      } catch (e, s) {
                        log("$e\n$s");
                        defaultToast(context, "Operation failed:$e");
                      } finally {
                        _collecting = false;
                      }
                      setState(() {});
          ...
          children: [
            Expanded(
              child: MaterialButton(
                ...
                child: Text(
                    "Continue reading : ${_viewLog!.chapterName} (${_viewLog!.pageRank + 1})"),
              ),
            ),
          ],
        ),
