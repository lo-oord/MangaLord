...
const _versionUrl =
    "https://api.github.com/repos/lo-oord/MangaLord/releases/latest";
...
Future manualCheckNewVersion(BuildContext context) async {
  try {
    defaultToast(context, "Checking for updates");
    await _versionCheck();
    defaultToast(context, "Update check completed");
  } catch (e) {
    defaultToast(context, "Update check failed: $e");
  }
}
