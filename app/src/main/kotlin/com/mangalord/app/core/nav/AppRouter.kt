...
import com.mangalord.app.browser.BrowserActivity
import com.mangalord.app.browser.cloudflare.CloudFlareActivity
...
import com.mangalord.app.core.model.appUrl
...
import com.mangalord.app.core.parser.external.ExternalMangaSource
import com.mangalord.app.core.prefs.AppSettings
import com.mangalord.app.core.prefs.ReaderMode
import com.mangalord.app.core.prefs.TriStateOption
import com.mangalord.app.core.ui.dialog.BigButtonsAlertDialog
import com.mangalord.app.core.ui.dialog.ErrorDetailsDialog
...
import com.mangalord.app.core.util.ext.getThemeDrawable
import com.mangalord.app.core.util.ext.printStackTraceDebug
import com.mangalord.app.core.util.ext.toFileOrNull
import com.mangalord.app.core.util.ext.toUriOrNull
import com.mangalord.app.core.util.ext.withArgs
import com.mangalord.app.details.ui.DetailsActivity
import com.mangalord.app.details.ui.pager.ChaptersPagesSheet
import com.mangalord.app.details.ui.related.RelatedMangaActivity
import com.mangalord.app.details.ui.scrobbling.ScrobblingInfoSheet
import com.mangalord.app.download.ui.dialog.DownloadDialogFragment
import com.mangalord.app.download.ui.list.DownloadsActivity
import com.mangalord.app.favourites.ui.FavouritesActivity
import com.mangalord.app.favourites.ui.categories.FavouriteCategoriesActivity
import com.mangalord.app.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import com.mangalord.app.favourites.ui.categories.select.FavoriteDialog
import com.mangalord.app.filter.ui.FilterCoordinator
import com.mangalord.app.filter.ui.sheet.FilterSheetFragment
import com.mangalord.app.filter.ui.tags.TagsCatalogSheet
import com.mangalord.app.history.ui.HistoryActivity
import com.mangalord.app.image.ui.ImageActivity
import com.mangalord.app.list.ui.config.ListConfigBottomSheet
import com.mangalord.app.list.ui.config.ListConfigSection
import com.mangalord.app.local.ui.ImportDialogFragment
import com.mangalord.app.local.ui.info.LocalInfoDialog
import com.mangalord.app.main.ui.MainActivity
import com.mangalord.app.main.ui.welcome.WelcomeSheet
...
import com.mangalord.app.reader.ui.colorfilter.ColorFilterConfigActivity
import com.mangalord.app.reader.ui.config.ReaderConfigSheet
import com.mangalord.app.scrobbling.common.domain.model.ScrobblerService
import com.mangalord.app.scrobbling.common.ui.config.ScrobblerConfigActivity
import com.mangalord.app.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import com.mangalord.app.search.domain.SearchKind
import com.mangalord.app.search.ui.MangaListActivity
import com.mangalord.app.search.ui.multi.SearchActivity
import com.mangalord.app.settings.SettingsActivity
import com.mangalord.app.settings.about.AppUpdateActivity
import com.mangalord.app.settings.override.OverrideConfigActivity
import com.mangalord.app.settings.reader.ReaderTapGridConfigActivity
import com.mangalord.app.settings.sources.auth.SourceAuthActivity
import com.mangalord.app.settings.sources.catalog.SourcesCatalogActivity
import com.mangalord.app.settings.storage.MangaDirectorySelectDialog
import com.mangalord.app.settings.storage.directories.MangaDirectoriesActivity
import com.mangalord.app.settings.tracker.categories.TrackerCategoriesConfigSheet
import com.mangalord.app.stats.ui.StatsActivity
import com.mangalord.app.stats.ui.sheet.MangaStatsSheet
import com.mangalord.app.suggestions.ui.SuggestionsActivity
import com.mangalord.app.tracker.ui.updates.UpdatesActivity
import java.io.File
