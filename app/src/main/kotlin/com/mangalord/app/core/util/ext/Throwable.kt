...
import com.mangalord.app.core.exceptions.BadBackupFormatException
import com.mangalord.app.core.exceptions.CaughtException
import com.mangalord.app.core.exceptions.CloudFlareBlockedException
...
import com.mangalord.app.core.exceptions.EmptyMangaException
import com.mangalord.app.core.exceptions.IncompatiblePluginException
import com.mangalord.app.core.exceptions.InteractiveActionRequiredException
import com.mangalord.app.core.exceptions.NoDataReceivedException
import com.mangalord.app.core.exceptions.NonFileUriException
import com.mangalord.app.core.exceptions.ProxyConfigException
import com.mangalord.app.core.exceptions.SyncApiException
import com.mangalord.app.core.exceptions.UnsupportedFileException
import com.mangalord.app.core.exceptions.UnsupportedSourceException
import com.mangalord.app.core.exceptions.WrapperIOException
import com.mangalord.app.core.exceptions.WrongPasswordException
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.mangalord.app/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.mangalord.app/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
