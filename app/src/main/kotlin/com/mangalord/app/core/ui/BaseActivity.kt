...
import com.mangalord.app.core.ui.util.ActionModeDelegate
import com.mangalord.app.core.util.ext.isWebViewUnavailable
...
abstract class BaseActivity<B : ViewBinding> :
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		if (isAmoledTheme) {
			setTheme(R.style.ThemeOverlay_MangaLord_Amoled)
		}
