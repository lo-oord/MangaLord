package com.mangalord.app.settings.userdata.storage
...
import com.mangalord.app.core.ui.widgets.SegmentedBarView
import com.mangalord.app.core.util.FileSize
import com.mangalord.app.core.util.MangaLordColors
import com.mangalord.app.databinding.PreferenceMemoryUsageBinding
...
class StorageUsagePreference @JvmOverloads constructor(
	...
	override fun onBindViewHolder(holder: PreferenceViewHolder) {
		...
		val storageSegment = SegmentedBarView.Segment(
			...
			MangaLordColors.segmentColorRandom(context, Color.BLUE),
		)
		val pagesSegment = SegmentedBarView.Segment(
			usage?.pagesCache?.percent ?: 0f,
			MangaLordColors.segmentColorRandom(context, Color.GREEN),
		)
		val otherSegment = SegmentedBarView.Segment(
			usage?.otherCache?.percent ?: 0f,
			MangaLordColors.segmentColorRandom(context, Color.GRAY),
		)
