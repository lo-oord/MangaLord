package com.mangalord.app.scrobbling.kitsu.ui
...
import com.mangalord.app.databinding.ActivityKitsuAuthBinding
...
class KitsuAuthActivity : BaseActivity<ActivityKitsuAuthBinding>(),
	...
	private fun continueAuth() {
		...
		val url = "mangalord://kitsu-auth?code=" + "$email;$password".urlEncoded()
