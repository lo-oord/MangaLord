package com.mangalord.app.local.ui.info
...
import com.mangalord.app.databinding.DialogLocalInfoBinding
...
class LocalInfoDialog : AlertDialogFragment<DialogLocalInfoBinding>(), View.OnClickListener {
	...
	private fun setSegments(size: Long, available: Long) {
		...
		val segment = SegmentedBarView.Segment(
			...
			color = MangaLordColors.segmentColor(view.context, appcompatR.attr.colorPrimary),
		)
