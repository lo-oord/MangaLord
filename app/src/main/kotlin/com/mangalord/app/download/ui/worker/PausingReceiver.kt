...
import com.mangalord.app.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.mangalord.app.download.PAUSE"
		private const val ACTION_RESUME = "com.mangalord.app.download.RESUME"
		private const val ACTION_SKIP = "com.mangalord.app.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.mangalord.app.download.SKIP_ALL"
