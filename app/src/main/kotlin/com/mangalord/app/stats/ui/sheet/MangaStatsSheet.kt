package com.mangalord.app.stats.ui.sheet
...
import com.mangalord.app.databinding.SheetStatsMangaBinding
import org.koitharu.kotatsu.parsers.util.format
import com.mangalord.app.stats.ui.views.BarChartView
...
class MangaStatsSheet : BaseAdaptiveSheet<SheetStatsMangaBinding>(), View.OnClickListener {
	...
	override fun onViewBindingCreated(binding: SheetStatsMangaBinding, savedInstanceState: Bundle?) {
		...
		binding.chartView.barColor = MangaLordColors.ofManga(binding.root.context, viewModel.manga)
