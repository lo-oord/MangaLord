...
import com.mlord.R
import com.mlord.core.exceptions.CloudFlareException
import com.mlord.core.exceptions.resolve.CaptchaHandler
import com.mlord.core.model.distinctById
import com.mlord.core.model.getLocale
...
import com.mlord.core.util.ext.awaitUniqueWorkInfoByName
import com.mlord.core.util.ext.awaitWorkInfosByTag
import com.mlord.core.util.ext.checkNotificationPermission
import com.mlord.core.util.ext.flatten
...
import com.mlord.core.util.ext.takeMostFrequent
import com.mlord.core.util.ext.toBitmapOrNull
import com.mlord.core.util.ext.trySetForeground
...
import com.mlord.suggestions.domain.MangaSuggestion
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "com.mlord.SUGGESTIONS"
