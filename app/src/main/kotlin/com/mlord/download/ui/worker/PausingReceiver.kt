...
import com.mlord.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.mlord.download.PAUSE"
		private const val ACTION_RESUME = "com.mlord.download.RESUME"
		private const val ACTION_SKIP = "com.mlord.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.mlord.download.SKIP_ALL"
