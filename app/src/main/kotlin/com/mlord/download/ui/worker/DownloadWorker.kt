package com.mlord.download.ui.worker
...
import com.mlord.core.network.imageproxy.ImageProxyInterceptor
...
import com.mlord.core.util.Throttler
import com.mlord.core.util.ext.MimeType
import com.mlord.core.util.ext.awaitFinishedWorkInfosByTag
import com.mlord.core.util.ext.awaitUpdateWork
import com.mlord.core.util.ext.awaitWorkInfosByTag
import com.mlord.core.util.ext.deleteAwait
import com.mlord.core.util.ext.deleteWork
import com.mlord.core.util.ext.deleteWorks
import com.mlord.core.util.ext.ensureSuccess
import com.mlord.core.util.ext.getDisplayMessage
import com.mlord.core.util.ext.getWorkInputData
import com.mlord.core.util.ext.getWorkSpec
import com.mlord.core.util.ext.openSource
...
import com.mlord.core.util.ext.withTicker
import com.mlord.core.util.ext.writeAllCancellable
import com.mlord.core.util.progress.RealtimeEtaEstimator
import com.mlord.download.domain.DownloadProgress
...
import com.mlord.local.data.TempFileFilter
import com.mlord.local.data.input.LocalMangaParser
import com.mlord.local.data.output.LocalMangaOutput
import com.mlord.local.domain.MangaLock
