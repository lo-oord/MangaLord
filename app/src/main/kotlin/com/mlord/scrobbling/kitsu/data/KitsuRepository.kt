package com.mlord.scrobbling.kitsu.data
...
import com.mlord.core.util.ext.parseJsonOrNull
import com.mlord.parsers.util.await
import com.mlord.parsers.util.json.getFloatOrDefault
import com.mlord.parsers.util.json.getIntOrDefault
import com.mlord.parsers.util.json.getStringOrNull
import com.mlord.parsers.util.json.mapJSON
...
import com.mlord.scrobbling.common.domain.model.ScrobblerMangaInfo
...
import com.mlord.scrobbling.kitsu.data.KitsuInterceptor.Companion.VND_JSON
...
class KitsuRepository(
	...
	override val oauthUrl: String = "mlord+kitsu://auth"
