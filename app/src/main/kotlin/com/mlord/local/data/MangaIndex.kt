...
import com.mlord.parsers.util.json.getEnumValueOrNull
import com.mlord.parsers.util.json.getFloatOrDefault
import com.mlord.parsers.util.json.getIntOrDefault
import com.mlord.parsers.util.json.getLongOrDefault
import com.mlord.parsers.util.json.getStringOrNull
import com.mlord.parsers.util.json.mapJSONToSet
import com.mlord.parsers.util.json.toStringSet
...
class MangaIndex(source: String?) {
	...
	fun sortChaptersByName() {
		...
		val comparator = com.mlord.core.util.AlphanumComparator()
