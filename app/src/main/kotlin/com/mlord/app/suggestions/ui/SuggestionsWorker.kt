...
import com.mlord.app.core.exceptions.CloudFlareException
import com.mlord.app.core.exceptions.resolve.CaptchaHandler
import com.mlord.app.core.model.distinctById
import com.mlord.app.core.model.getLocale
...
import com.mlord.app.core.util.LocaleComparator
import com.mlord.app.core.util.ext.asArrayList
import com.mlord.app.core.util.ext.awaitUniqueWorkInfoByName
import com.mlord.app.core.util.ext.awaitWorkInfosByTag
import com.mlord.app.core.util.ext.checkNotificationPermission
import com.mlord.app.core.util.ext.flatten
...
import com.mlord.app.core.util.ext.takeMostFrequent
import com.mlord.app.core.util.ext.toBitmapOrNull
import com.mlord.app.core.util.ext.trySetForeground
...
import com.mlord.app.settings.work.PeriodicWorkScheduler
import com.mlord.app.suggestions.domain.MangaSuggestion
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "com.mlord.app.SUGGESTIONS"
