...
import com.mlord.app.app.core.util.ext.URI_SCHEME_ZIP
import com.mlord.app.app.core.util.ext.cancelChildrenAndJoin
import com.mlord.app.app.core.util.ext.compressToPNG
import com.mlord.app.app.core.util.ext.ensureRamAtLeast
import com.mlord.app.app.core.util.ext.ensureSuccess
import com.mlord.app.app.core.util.ext.getCompletionResultOrNull
import com.mlord.app.app.core.util.ext.isFileUri
import com.mlord.app.app.core.util.ext.isNotEmpty
import com.mlord.app.app.core.util.ext.isPowerSaveMode
...
import com.mlord.app.app.core.util.ext.ramAvailable
import com.mlord.app.app.core.util.ext.toMimeType
import com.mlord.app.app.core.util.ext.use
import com.mlord.app.app.core.util.ext.withProgress
import com.mlord.app.app.core.util.progress.ProgressDeferred
import com.mlord.app.app.download.ui.worker.DownloadSlowdownDispatcher
