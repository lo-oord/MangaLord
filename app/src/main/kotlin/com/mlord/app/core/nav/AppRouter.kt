...
import com.mlord.app.alternatives.ui.AlternativesActivity
import com.mlord.app.backups.ui.backup.BackupDialogFragment
import com.mlord.app.backups.ui.restore.RestoreDialogFragment
import com.mlord.app.bookmarks.ui.AllBookmarksActivity
import com.mlord.app.browser.BrowserActivity
import com.mlord.app.browser.cloudflare.CloudFlareActivity
import com.mlord.app.core.exceptions.CloudFlareProtectedException
import com.mlord.app.core.image.CoilMemoryCacheKey
import com.mlord.app.core.model.FavouriteCategory
import com.mlord.app.core.model.MangaSourceInfo
import com.mlord.app.core.model.appUrl
import com.mlord.app.core.model.getTitle
import com.mlord.app.core.model.isBroken
import com.mlord.app.core.model.isLocal
import com.mlord.app.core.model.parcelable.ParcelableManga
import com.mlord.app.core.model.parcelable.ParcelableMangaListFilter
import com.mlord.app.core.model.parcelable.ParcelableMangaPage
import com.mlord.app.core.network.CommonHeaders
import com.mlord.app.core.parser.external.ExternalMangaSource
...
import com.mlord.app.core.ui.dialog.BigButtonsAlertDialog
import com.mlord.app.core.ui.dialog.ErrorDetailsDialog
import com.mlord.app.core.ui.dialog.buildAlertDialog
import com.mlord.app.core.util.ext.connectivityManager
...
import com.mlord.app.details.ui.DetailsActivity
import com.mlord.app.details.ui.pager.ChaptersPagesSheet
import com.mlord.app.details.ui.related.RelatedMangaActivity
import com.mlord.app.details.ui.scrobbling.ScrobblingInfoSheet
import com.mlord.app.download.ui.dialog.DownloadDialogFragment
import com.mlord.app.download.ui.list.DownloadsActivity
import com.mlord.app.favourites.ui.FavouritesActivity
import com.mlord.app.favourites.ui.categories.FavouriteCategoriesActivity
import com.mlord.app.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import com.mlord.app.favourites.ui.categories.select.FavoriteDialog
import com.mlord.app.filter.ui.FilterCoordinator
import com.mlord.app.filter.ui.sheet.FilterSheetFragment
import com.mlord.app.filter.ui.tags.TagsCatalogSheet
import com.mlord.app.history.ui.HistoryActivity
import com.mlord.app.image.ui.ImageActivity
import com.mlord.app.list.ui.config.ListConfigBottomSheet
import com.mlord.app.list.ui.config.ListConfigSection
import com.mlord.app.local.ui.ImportDialogFragment
import com.mlord.app.local.ui.info.LocalInfoDialog
import com.mlord.app.main.ui.MainActivity
import com.mlord.app.main.ui.welcome.WelcomeSheet
...
import com.mlord.app.reader.ui.colorfilter.ColorFilterConfigActivity
import com.mlord.app.reader.ui.config.ReaderConfigSheet
import com.mlord.app.scrobbling.common.domain.model.ScrobblerService
import com.mlord.app.scrobbling.common.ui.config.ScrobblerConfigActivity
import com.mlord.app.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import com.mlord.app.search.domain.SearchKind
import com.mlord.app.search.ui.MangaListActivity
import com.mlord.app.search.ui.multi.SearchActivity
import com.mlord.app.settings.SettingsActivity
import com.mlord.app.settings.about.AppUpdateActivity
import com.mlord.app.settings.override.OverrideConfigActivity
import com.mlord.app.settings.reader.ReaderTapGridConfigActivity
import com.mlord.app.settings.sources.auth.SourceAuthActivity
import com.mlord.app.settings.sources.catalog.SourcesCatalogActivity
import com.mlord.app.settings.storage.MangaDirectorySelectDialog
import com.mlord.app.settings.storage.directories.MangaDirectoriesActivity
import com.mlord.app.settings.tracker.categories.TrackerCategoriesConfigSheet
import com.mlord.app.stats.ui.StatsActivity
import com.mlord.app.stats.ui.sheet.MangaStatsSheet
import com.mlord.app.suggestions.ui.SuggestionsActivity
import com.mlord.app.tracker.ui.updates.UpdatesActivity
import java.io.File
