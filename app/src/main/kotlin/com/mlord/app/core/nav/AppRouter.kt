...
import com.mlord.app.app.alternatives.ui.AlternativesActivity
import com.mlord.app.app.backups.ui.backup.BackupDialogFragment
import com.mlord.app.app.backups.ui.restore.RestoreDialogFragment
import com.mlord.app.app.bookmarks.ui.AllBookmarksActivity
import com.mlord.app.app.browser.BrowserActivity
import com.mlord.app.app.browser.cloudflare.CloudFlareActivity
...
import com.mlord.app.app.core.model.isBroken
import com.mlord.app.app.core.model.isLocal
import com.mlord.app.app.core.model.parcelable.ParcelableManga
import com.mlord.app.app.core.model.parcelable.ParcelableMangaListFilter
...
import com.mlord.app.app.core.ui.dialog.BigButtonsAlertDialog
import com.mlord.app.app.core.ui.dialog.ErrorDetailsDialog
import com.mlord.app.app.core.ui.dialog.buildAlertDialog
import com.mlord.app.app.core.util.ext.connectivityManager
...
import com.mlord.app.app.details.ui.related.RelatedMangaActivity
import com.mlord.app.app.details.ui.scrobbling.ScrobblingInfoSheet
import com.mlord.app.app.download.ui.dialog.DownloadDialogFragment
import com.mlord.app.app.download.ui.list.DownloadsActivity
import com.mlord.app.app.favourites.ui.FavouritesActivity
import com.mlord.app.app.favourites.ui.categories.FavouriteCategoriesActivity
import com.mlord.app.app.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import com.mlord.app.app.favourites.ui.categories.select.FavoriteDialog
import com.mlord.app.app.filter.ui.FilterCoordinator
import com.mlord.app.app.filter.ui.sheet.FilterSheetFragment
import com.mlord.app.app.filter.ui.tags.TagsCatalogSheet
import com.mlord.app.app.history.ui.HistoryActivity
import com.mlord.app.app.image.ui.ImageActivity
import com.mlord.app.app.list.ui.config.ListConfigBottomSheet
import com.mlord.app.app.list.ui.config.ListConfigSection
import com.mlord.app.app.local.ui.ImportDialogFragment
import com.mlord.app.app.local.ui.info.LocalInfoDialog
import com.mlord.app.app.main.ui.MainActivity
import com.mlord.app.app.main.ui.welcome.WelcomeSheet
...
import com.mlord.app.app.reader.ui.colorfilter.ColorFilterConfigActivity
import com.mlord.app.app.reader.ui.config.ReaderConfigSheet
import com.mlord.app.app.scrobbling.common.domain.model.ScrobblerService
import com.mlord.app.app.scrobbling.common.ui.config.ScrobblerConfigActivity
import com.mlord.app.app.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import com.mlord.app.app.search.domain.SearchKind
import com.mlord.app.app.search.ui.MangaListActivity
import com.mlord.app.app.search.ui.multi.SearchActivity
import com.mlord.app.app.settings.SettingsActivity
import com.mlord.app.app.settings.about.AppUpdateActivity
import com.mlord.app.app.settings.override.OverrideConfigActivity
import com.mlord.app.app.settings.reader.ReaderTapGridConfigActivity
import com.mlord.app.app.settings.sources.auth.SourceAuthActivity
import com.mlord.app.app.settings.sources.catalog.SourcesCatalogActivity
import com.mlord.app.app.settings.storage.MangaDirectorySelectDialog
import com.mlord.app.app.settings.storage.directories.MangaDirectoriesActivity
import com.mlord.app.app.settings.tracker.categories.TrackerCategoriesConfigSheet
import com.mlord.app.app.stats.ui.StatsActivity
import com.mlord.app.app.stats.ui.sheet.MangaStatsSheet
import com.mlord.app.app.suggestions.ui.SuggestionsActivity
import com.mlord.app.app.tracker.ui.updates.UpdatesActivity
import java.io.File
