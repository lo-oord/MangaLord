...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.mlord.app.download.PAUSE"
		private const val ACTION_RESUME = "com.mlord.app.download.RESUME"
		private const val ACTION_SKIP = "com.mlord.app.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.mlord.app.download.SKIP_ALL"
