...
import com.mlord.app.app.core.network.CurlLoggingInterceptor
import com.mlord.app.app.scrobbling.anilist.data.AniListAuthenticator
import com.mlord.app.app.scrobbling.anilist.data.AniListInterceptor
import com.mlord.app.app.scrobbling.anilist.domain.AniListScrobbler
...
import com.mlord.app.app.scrobbling.kitsu.data.KitsuAuthenticator
import com.mlord.app.app.scrobbling.kitsu.data.KitsuInterceptor
import com.mlord.app.app.scrobbling.kitsu.data.KitsuRepository
import com.mlord.app.app.scrobbling.kitsu.domain.KitsuScrobbler
import com.mlord.app.app.scrobbling.mal.data.MALAuthenticator
import com.mlord.app.app.scrobbling.mal.data.MALInterceptor
import com.mlord.app.app.scrobbling.mal.domain.MALScrobbler
import com.mlord.app.app.scrobbling.shikimori.data.ShikimoriAuthenticator
import com.mlord.app.app.scrobbling.shikimori.data.ShikimoriInterceptor
import com.mlord.app.app.scrobbling.shikimori.domain.ShikimoriScrobbler
