package com.mlord.core.util.ext
...
import com.mlord.R
import com.mlord.core.exceptions.BadBackupFormatException
import com.mlord.core.exceptions.CaughtException
...
import com.mlord.core.exceptions.EmptyMangaException
import com.mlord.core.exceptions.IncompatiblePluginException
...
import com.mlord.core.exceptions.NonFileUriException
import com.mlord.core.exceptions.ProxyConfigException
import com.mlord.core.exceptions.SyncApiException
import com.mlord.core.exceptions.UnsupportedFileException
import com.mlord.core.exceptions.UnsupportedSourceException
import com.mlord.core.exceptions.WrapperIOException
import com.mlord.core.exceptions.WrongPasswordException
import com.mlord.core.exceptions.resolve.ExceptionResolver
import com.mlord.parsers.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import com.mlord.parsers.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import com.mlord.parsers.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import com.mlord.parsers.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import com.mlord.parsers.ErrorMessages.SEARCH_NOT_SUPPORTED
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.mlord/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.mlord/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
